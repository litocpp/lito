...
It uses `lito.toml` to define packages, workspaces, targets, dependencies, and build policy.  
It also discovers named module sources and drives Clang, LLD, and LLVM tools.  
