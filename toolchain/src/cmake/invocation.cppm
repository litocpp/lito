...
auto cmake_cxx_flags(const cpp::ProfileSpec& profile) -> String {
    ...
    result.push_ascii(' ');
    result.push_str(cpp::cpp_optimization_option(profile.cpp.codegen.optimization));
    result.push_ascii(' ');
    result.push_str(cpp::cpp_debug_option(profile.cpp.codegen.debug_info));
    result.push_ascii(' ');
    result.push_str(cpp::cpp_lto_option(profile.cpp.codegen.lto));
    return result;
}
