export module lito.toolchain.clang:preprocessor_query;
...
auto query_text_builtins(const Vec<String>&                base_command,
    ...
    auto parsed =
        each_line(output->standard_output.as_str(), [&](ref<str> raw) -> ToolchainResult<empty> {
