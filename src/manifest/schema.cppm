...
auto table_value(const Toml& value, ref<str> context)
    -> Result<ref<Table>> {
...
auto required_table(const Toml& document,
                    ref<str> key,
                    ref<str> context) -> Result<ref<Table>> {
...
auto optional_string(const Toml& table,
                     ref<str> key,
                     ref<str> context) -> Result<Option<String>> {
    auto value = member(table, key);
...
auto reject_unknown(const Table& table,
                    ref<str> context,
                    KeyPredicate allowed) -> Result<empty> {
...
auto declared_paths(Option<ref<Toml>> value,
                    ref<str> context,
...
auto resolve_directories(Option<ref<Toml>> value,
                         ref<rstd::path::Path> root,
                         ref<str> context) -> Result<Vec<PathBuf>> {
...
auto validate_options(const Vec<String>& options, ref<str> context)
    -> Result<empty> {
...
auto validate_definitions(const Vec<String>& definitions, ref<str> context)
    -> Result<empty> {
...
auto parse_dependencies(Option<ref<Toml>> value)
