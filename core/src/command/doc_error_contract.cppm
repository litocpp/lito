...
export module lito.command.doc_error_contract;
...
template<typename T>
using DocResult = rstd::Result<T, DocError>;
...
template<>
struct Impl<convert::From<lito::SystemError>, lito::DocError> {
    static auto from(lito::SystemError error) -> lito::DocError {
