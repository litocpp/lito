...
TEST(Cpp, NormalizesCommonOptionsBeforeToolchainMapping) {
    ...
    auto draft_standard = cpp_options(
        "c++2b"_str, lito::manifest::CppOptimization::None, lito::manifest::CppDebugInfo::None);
    auto published_standard = cpp_options(
        "c++23"_str, lito::manifest::CppOptimization::None, lito::manifest::CppDebugInfo::None);
